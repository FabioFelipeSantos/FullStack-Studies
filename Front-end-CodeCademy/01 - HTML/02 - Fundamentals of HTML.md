...
- The `target` attribute specifies how a link should open. For a link to open in a new window, the `target`
...
- We specified the type by using `type="value"` and named what kind of audio it is. Although not always
